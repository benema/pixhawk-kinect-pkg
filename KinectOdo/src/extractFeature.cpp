		...
		if(called==1)
		{
...

			{
				...
				if(counter==0)
				{
					...
					KeyFrameMarker.pose.pose.orientation.x=quat_rot_keyframe.x();//+cos(M_1_PI/2.0);
					KeyFrameMarker.pose.pose.orientation.y=quat_rot_keyframe.y();//-cos(M_1_PI/2.0);
					KeyFrameMarker.pose.pose.orientation.z=quat_rot_keyframe.z();//+cos(M_1_PI/2.0);
